...
for sentence in meacb_tokenizer(corpuses):
    model = Word2Vec.load('Models/word2vec_model/GJ&case_mecab_ing_word2vec_2.model')
...
np.save('C:/Users/김민주/project/Safety_Helmet/Models/sentence_vector/sentence_vector.npy', result_np)
