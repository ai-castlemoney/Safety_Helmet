...
#answer = meacb_tokenizer(corpuses[10000:11001])
#print(answer[:3])

################################
vectors_path = 'C:/Users/김민주/project/Safety_Helmet/Models_2/word2vec_model/final_nantest_data_vectors_tsv.tsv'
words_path = 'C:/Users/김민주/project/Safety_Helmet/Models_2/word2vec_model/final_nantest_data_words_tsv.tsv'
...
# 예상 shape : (20114, 300)
print('차원', result_np.shape)
np.save('Models_2/create_sentence_vector/final_data_r1_sentence_vector_nanmean.npy', result_np)
