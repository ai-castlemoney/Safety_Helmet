...
read_dir = '/Users/namcheolher/aiffel/Safety_Helmet/utility_functions/nnp _UTF8.csv' # csv 읽을 경로
save_dir = '/Users/namcheolher/aiffel/Safety_Helmet/utility_functions/nnp _UTF8_r1.csv' # 처리후 csv 저장 경로
